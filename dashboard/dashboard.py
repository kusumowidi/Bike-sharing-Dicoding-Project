...
print("Column Names:", day_df.columns)

# Data Cleaning
# Drop unnecessary columns
drop_col = ['instant', 'windspeed']

# Verify if all columns in drop_col exist in day_df
missing_columns = [col for col in drop_col if col not in day_df.columns]
if missing_columns:
    st.error(f"Columns {missing_columns} not found in the DataFrame.")
else:
